<?php
//AddMember is essentially a clone of Home.php, but AddMember.php calls the viewer's addMember function before it renders the data.
//Once the data is rendered the new member is queried, and the data can be filtered to return to home or other functions can be performed as normal.
